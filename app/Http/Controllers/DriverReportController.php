...
class DriverReportController extends Controller
{
    ...
    public function report(Request $request)
    {
        ...
        return view('driver_report', compact('bookings', 'dropoffs', 'fdate', 'tdate', 'search', 'rooms', 'sumpax', 'sumpax_dropoff'));
    }

    public function filter(Request $request)
    {
        return redirect()->route('driver_report', [
