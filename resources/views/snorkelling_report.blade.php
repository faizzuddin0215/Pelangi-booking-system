    ...
    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 text-gray-900 dark:text-gray-100">
            <div class="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm">
                <form method="post" action="{{ route('snorkelling_report.filter') }}">
                    @csrf
                                    ...
                                    <table class="table-auto w-full border-collapse border border-gray-300">
                                        <thead>
                                            <tr class="bg-gray-100 text-left">
                                                ...
                                                <th class="border border-gray-300 p-2 print:p-[2px]">Contact Name</th>
                                                <th class="border border-gray-300 p-2 print:p-[2px]">Pax</th>
                                                <th class="border border-gray-300 p-2 print:p-[2px]">Room Allocated</th>
                                                <th class="border border-gray-300 p-2 print:p-[2px]">Dive Package</th>
                                                <th class="border border-gray-300 p-2 print:p-[2px]">Dive Package</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @if ($inHouse && count($inHouse) > 0)
                                                ...
                                                <tr class="odd:bg-white even:bg-gray-50">
                                                    <td class="border border-gray-300 p-2 print:p-[2px] w-[50px] print:w-[20px]">
                                                        {{ $loop->iteration }}
                                                    </td>
                                                    ...
                                                    <td class="border border-gray-300 p-2 print:p-[2px]">
                                                        {{ $row->dive_package == 1 ? 'Y' : '' }}
                                                    </td>
                                                   
                                                    <td class="border border-gray-300 p-2 print:p-[2px] w-[60px] print:w-[30px]">
                                                        {{ $row->optional_code1 }} ({{ $row->optional01_pax }}) {{ $row->optional_code2 }} ({{ $row->optional02_pax }}) {{ $row->optional_code3 }} ({{ $row->optional03_pax }}) {{ $row->optional_code4 }} ({{ $row->optional04_pax }}) {{ $row->optional_code5 }} ({{ $row->optional05_pax }})
                                                    </td>
                                                </tr>
                                                @endforeach
                                            @else
