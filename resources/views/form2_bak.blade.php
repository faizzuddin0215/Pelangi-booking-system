                ...
                <div class="flex justify-between items-center flex-wrap">
                    <nav class="mb-4" aria-label="Breadcrumb">
                        <ol class="flex flex-wrap items-center space-x-3 text-sm text-gray-600 dark:text-gray-300">
                            {{-- <li>
                                <a href="{{ route('dashboard') }}" class="hover:text-indigo-500">Home</a>
                            </li> --}}
                            {{-- <li><span class="text-gray-400">|</span></li> --}}
                            <li>
                                <a href="{{ url('form') }}?booking={{ $bookings->booking_id }}" class="hover:text-indigo-500">
                                    Basic Information
                                </a>
                            </li>
                            <li><span class="text-gray-400">|</span></li>
                            <li>
                                <a href="{{ url('form2', $bookings->booking_id) }}" class="text-indigo-600 font-semibold">
                                    Room Details
                                </a>
                            </li>
                            <li><span class="text-gray-400">|</span></li>
                            <li>
                                <a href="{{ url('form3', $bookings->booking_id) }}" class="hover:text-indigo-500">
                                    Land Transfer & Optional
                                </a>
                            </li>
                            <li><span class="text-gray-400">|</span></li>
                            <li>
                                <a href="{{ url('form4', $bookings->booking_id) }}" class="hover:text-indigo-500">
                                    Remarks
                                </a>
                            </li>
                            <li><span class="text-gray-400">|</span></li>
                            <li>
                                <a href="{{ url('form5', $bookings->booking_id) }}" class="hover:text-indigo-500">
                                    Summary & Payment
                                </a>
                            </li>
                        </ol>
                    ...
                    <div class="text-sm text-gray-700 dark:text-gray-300 space-y-1">
                        <div class="text-lg font-semibold text-gray-900 dark:text-white">#{{ $bookings->booking_id }}</div>
                                ...
                                <table class="table-auto w-full border border-gray-300 text-left">
                                    <thead class="bg-gray-100">
                                        ...
                                        <tr class="text-xs">
                                            ...
                                            <th class="border border-gray-300 px-4 py-2 font-semibold text-gray-700">x</th>
                                            <th class="border border-gray-300 px-4 py-2 font-semibold text-gray-700 {{ (fmod($sum_rooms['sum_triple'], 1) !== 0.0) ? 'text-red-500' : '' }}" id="sum_triple_pax" value="0">{{ $sum_rooms['sum_triple_ceil'] }}</th>
                                            <th class="border border-gray-300 px-4 py-2 font-semibold text-gray-700">Matt (RM)</th>
                                            ...
                                            <th class="border border-gray-300 px-4 py-2 font-semibold text-gray-700">x</th>
                                            <th class="border border-gray-300 px-4 py-2 font-semibold text-gray-700 {{ (fmod($sum_rooms['sum_quad'], 1) !== 0.0) ? 'text-red-500' : '' }}" id="sum_quad_pax" value="0">{{ $sum_rooms['sum_quad_ceil'] }}</th>
                                            <th class="border border-gray-300 px-4 py-2 font-semibold text-gray-700">Matt (RM)</th>
                                ...
                                <table class="table-auto w-full border border-gray-300 text-left">
                                    <thead class="bg-gray-100">
                                        ...
                                        <tr class="text-xs">
                                            ...
                                            <th class="border border-gray-300 px-4 py-2 font-semibold text-gray-700">Double (RM)</th>
                                            <th class="border border-gray-300 px-4 py-2 font-semibold text-gray-700">x</th>
                                            <th class="border border-gray-300 px-4 py-2 font-semibold text-gray-700" id="sea_sum_double_pax" value="0"></th>
                                            <th class="border border-gray-300 px-4 py-2 font-semibold text-gray-700">Matt (RM)</th>
...
<script>
    ...
    function showForm3() {
        ...
        window.location.href = "{{ url('form3') }}/" + bookingId;
    ...
    function save() {
        ...
        .then(data => {
            ...
            window.location.href = "{{ url('form2') }}/" + bookingId;
        })
    ...
    function changeValue() {
        ...
        let double_adult_pax = document.getElementById('double_adult_pax').value;
        let double_adult_mat_pax = document.getElementById('double_adult_mat_pax').value;
        let double_child_pax = document.getElementById('double_child_pax').value;
        let double_child_mat_pax = document.getElementById('double_child_mat_pax').value;
        let double_toddler_pax = document.getElementById('double_toddler_pax').value;

        let triple_adult_pax = document.getElementById('triple_adult_pax').value;
        let triple_child_pax = document.getElementById('triple_child_pax').value;
        let triple_toddler_pax = document.getElementById('triple_toddler_pax').value;

        let quad_adult_pax = document.getElementById('quad_adult_pax').value;
        let quad_adult_mat_pax = document.getElementById('quad_adult_mat_pax').value;
        let quad_child_pax = document.getElementById('quad_child_pax').value;
        let quad_child_mat_pax = document.getElementById('quad_child_mat_pax').value;
        let quad_toddler_pax = document.getElementById('quad_toddler_pax').value;

        // seaview
        let sea_double_adult_pax = document.getElementById('sea_double_adult_pax').value;
        let sea_double_adult_mat_pax = document.getElementById('sea_double_adult_mat_pax').value;
        let sea_double_child_pax = document.getElementById('sea_double_child_pax').value;
        let sea_double_child_mat_pax = document.getElementById('sea_double_child_mat_pax').value;
        let sea_double_toddler_pax = document.getElementById('sea_double_toddler_pax').value;
        let sea_triple_adult_pax = document.getElementById('sea_triple_adult_pax').value;
        let sea_triple_child_pax = document.getElementById('sea_triple_child_pax').value;
        let sea_triple_toddler_pax = document.getElementById('sea_triple_toddler_pax').value;
        let sea_quad_adult_pax = document.getElementById('sea_quad_adult_pax').value;
        let sea_quad_adult_mat_pax = document.getElementById('sea_quad_adult_mat_pax').value;
        let sea_quad_child_pax = document.getElementById('sea_quad_child_pax').value;
        let sea_quad_child_mat_pax = document.getElementById('sea_quad_child_mat_pax').value;
        let sea_quad_toddler_pax = document.getElementById('sea_quad_toddler_pax').value;
        ...
        fetch(`{{ url('/form2') }}/${bookingId}`, {
            ...
            body: JSON.stringify({
                ...
                check_out: checkOut,
                pax: {
                    double_adult_pax: double_adult_pax ? double_adult_pax : 0,
                    double_adult_mat_pax: double_adult_mat_pax ? double_adult_mat_pax : 0,
                    double_child_pax: double_child_pax ? double_child_pax : 0,
                    double_child_mat_pax: double_child_mat_pax ? double_child_mat_pax : 0,  // Fixed missing colon
                    double_toddler_pax: double_toddler_pax ? double_toddler_pax : 0,
                    triple_adult_pax: triple_adult_pax ? triple_adult_pax : 0,
                    triple_child_pax: triple_child_pax ? triple_child_pax : 0,
                    triple_toddler_pax: triple_toddler_pax ? triple_toddler_pax : 0,
                    quad_adult_pax: quad_adult_pax ? quad_adult_pax : 0,
                    quad_adult_mat_pax: quad_adult_mat_pax ? quad_adult_mat_pax : 0,
                    quad_child_pax: quad_child_pax ? quad_child_pax : 0,
                    quad_child_mat_pax: quad_child_mat_pax ? quad_child_mat_pax : 0,
                    quad_toddler_pax: quad_toddler_pax ? quad_toddler_pax : 0,
                    
                    // seaview
                    sea_double_adult_pax: sea_double_adult_pax ? sea_double_adult_pax : 0,
                    sea_double_adult_mat_pax: sea_double_adult_mat_pax ? sea_double_adult_mat_pax : 0,
                    sea_double_child_pax: sea_double_child_pax ? sea_double_child_pax : 0,
                    sea_double_child_mat_pax: sea_double_child_mat_pax ? sea_double_child_mat_pax : 0,  // Fixed missing colon
                    sea_double_toddler_pax: sea_double_toddler_pax ? sea_double_toddler_pax : 0,
                    sea_triple_adult_pax: sea_triple_adult_pax ? sea_triple_adult_pax : 0,
                    sea_triple_child_pax: sea_triple_child_pax ? sea_triple_child_pax : 0,
                    sea_triple_toddler_pax: sea_triple_toddler_pax ? sea_triple_toddler_pax : 0,
                    sea_quad_adult_pax: sea_quad_adult_pax ? sea_quad_adult_pax : 0,
                    sea_quad_adult_mat_pax: sea_quad_adult_mat_pax ? sea_quad_adult_mat_pax : 0,
                    sea_quad_child_pax: sea_quad_child_pax ? sea_quad_child_pax : 0,
                    sea_quad_child_mat_pax: sea_quad_child_mat_pax ? sea_quad_child_mat_pax : 0,
                    sea_quad_toddler_pax: sea_quad_toddler_pax ? sea_quad_toddler_pax : 0
                }
            })
